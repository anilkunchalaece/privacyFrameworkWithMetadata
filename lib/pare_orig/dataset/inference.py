...
class Inference(Dataset):
    def __init__(self, image_folder, frames=None, bboxes=None, joints2d=None,
        ...
        self.image_file_names = sorted(self.image_file_names, key=lambda x: int(os.path.basename(x).split(".")[0]))
...
class ImageFolder(Dataset):
    def __init__(self, image_folder, bboxes=None, joints2d=None,
        ...
        self.image_file_names = sorted(self.image_file_names, key= lambda x : int(x.split(".")[0]))
